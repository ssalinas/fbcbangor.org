class AddContent < ActiveRecord::Migration
  def self.up
    ...
    Content.create(page: 'about', section: 'Our Pastor', content: "The Rev. Stephanie A. Salinas is a graduate of New Brunswick Theological Seminary in New Brunswick, New Jersey. She and her husband and two sons united with us in August of 2002. Rev. Salinas is an enthusiastic preacher, a dedicated teacher, and a compassionate counselor. She is dedicated to mission locally and globally.", image_src: 'pastor_stephanie.jpg', priority: 2)
